...
var squareF = [ 0b0, 0b0, 0b0, 0b0 ];
  ...
  for (var i1 = 0; i1 < 6; i1++)
  {
    if (end) break;
      ...
      squareB = cube.data[i1].slice();
      squareBsymbol = cube.symbols[i1];
 ...
 // 6 flächen (wenn schon gebraucht = continue), flippen, drehen, flächen kontrollieren
      ...
      for (var j1 = 0; j1 < 6; j1++) 
      {
        ...
        for (var j2 = 0; j2 < 2; j2++)
        {
          ...
          flippedSquareC = cube.data[j1].slice();
          squareCsymbol = cube.symbols[j1];
          
          if (j2 == 1)
          {
            flippedSquareC = flipSquare(cube.data[j1]);
          }
            ...
            if (checkEdgeTree(squareB[3], squareC[1]))
            {
              for (var k1 = 0; k1 < 6; k1++)
              {
                ...
                for (var k2 = 0; k2 < 2; k2++)
                {
                  ...
                  flippedSquareD = cube.data[k1].slice();

                  squareDsymbol = cube.symbols[k1];
                  if (k2 == 1)
                    flippedSquareD = flipSquare(cube.data[k1]);
                    ...
                    if (checkEdgeTree(squareC[3], squareD[1]))
                    {
                      for (var l1 = 0; l1 < 6; l1++)
                      {
                        ...
                        for (var l2 = 0; l2 < 2; l2++)
                        {
                          ...
                          flippedSquareE = cube.data[l1].slice();
                          squareEsymbol = cube.symbols[l1];
                          if (l2 == 1)
                            flippedSquareE = flipSquare(cube.data[l1]);
                                 ...
                                 (checkEdgeTree(squareE[3], squareB[1])) )
                            {
                              ...
                              for (var m1 = 0; m1 < 6; m1++)
                              {
                                ...
                                for (var m2 = 0; m2 < 2; m2++)
                                {
                                  ...
                                  if (end) break;
                                  flippedSquareA = cube.data[m1].slice();
                                  squareAsymbol = cube.symbols[m1];
                                  if (m2 == 1)
                                    flippedSquareA = flipSquare(cube.data[m1]);
                                          ...
                                          if (cornerA2 == 1)
                                          {
                                            ...
                                            if (cornerA3 == 1)
                                            {
                                              ...
                                              for (var n2 = 0; n2 < 2; n2++)
                                              {
                                                ...
                                                flippedSquareF = cube.data[n1].slice();
                                                squareFsymbol = cube.symbols[n1];

                                                if (n2 == 1)
                                                  flippedSquareF = flipSquare(cube.data[n1]);
  ...
  drawSquare(cube, squareD, "D", squareDsymbol);
  drawSquare(cube, squareE, "E", squareEsymbol);
