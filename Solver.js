                                            ...
                                            if (cornerA3 == 1)
                                            {
                                              ...
                                              for (var n2 = 0; n2 < 2; n2++)
                                              {
                                                ...
                                                for (var n3 = 0; n3 < 4; n3++)
                                                {
                                                  ...
                                                  //check if the corner0 has exactly one of the three possible fields from the three squares
                                                    cornerF0 = 0;
                                                    console.log("sF0:" +getBitRow(squareF[0])+" " + getBitRow(squareF[0]) );
                                                    console.log("sC3:" +getBitRow(squareC[3])+" " + getBitRow(squareC[3]) );
                                                    console.log("sD2:" +getBitRow(squareD[2])+" " + getBitRow(squareD[2]) );
...
printBitSquare(squareB);
printBitSquare(squareC);
printBitSquare(squareD);
printBitSquare(squareE);
printBitSquare(squareA);
printBitSquare(squareF);
